...
const Index = () => {
  return (
    <div className="min-h-screen">
      <Navbar />
      {/* Hero Section */}
      <section className="relative h-screen w-full overflow-hidden bg-gradient-to-br from-gray-50 via-white to-gray-100">
        {/* Background Layers */}
        <img
          src="./media/page_1/1.png"
          alt="Layer 1"
          className="absolute top-0 left-0 w-full h-full object-cover z-10"
        />
        <img
          src="./media/page_1/2.png"
          alt="Layer 2"
          className="absolute top-0 left-0 w-full h-full object-cover z-20"
        />
        <img
          src="./media/page_1/3.png"
          alt="Layer 3"
          className="absolute top-0 left-0 w-full h-full object-auto z-20"
        />
        <img
          src="./media/page_1/4.png"
          alt="Layer 4"
          className="absolute top-0 left-0 w-full h-full z-20"
        />

        {/* Centered Text */}
        <div className="absolute bottom-[100px] left-1/2 transform -translate-x-1/2 text-center px-4 z-30 text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-[#2E5C9D] lg:whitespace-nowrap">
      ...
      <section className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-100 flex items-center justify-center px-4 sm:px-6 md:px-12 lg:px-16 relative overflow-hidden py-10">
        ...
        <img
          src="./media/page_2/3.png"
          alt="Workforce"
          className="absolute w-full top-0 object-cover"
        />
        <img
          src="./media/page_2/2.png"
          alt="Workforce"
          className="absolute w-full top-0 object-cover"
        />
        ...
        <div className="max-w-5xl mx-auto w-full relative z-10 space-y-8 text-center">
          ...
          <h2 className="text-sm sm:text-lg md:text-xl lg:text-2xl text-[#2E5C9D] font-bold leading-relaxed">
            Resonance Solutions – Bridging Skills, Employability &
            Sustainability
          </h2>
        </div>
      </section>
          ...
          <div className="space-y-8 text-center md:text-left">
            <div className="space-y-6">
              ...
              <p className="text-base sm:text-lg md:text-xl text-black font-bold leading-relaxed">
                A dynamic social enterprise advancing entrepreneurship and
                employability through skill development, strategic partnerships
                and innovation.
              </p>
            </div>

            <div className="space-y-6">
              <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl  font-bold text-[#2E5C9D] mb-4">
                Our Edge:
              </h3>
      ...
      <section className="h-auto lg:min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 flex justify-center relative overflow-hidden mt-5 py-10 lg:py-15 px-4 sm:px-6 lg:px-16">
        <img src="./media/page_4/5.png" className="absolute w-full object-cover z-10" />
        <div className="max-w-7xl w-full space-y-20 md:space-y-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 text-center md:text-left">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#2E5C9D]">
                Vision
              </h2>
              <p className="text-base sm:text-lg md:text-xl text-black font-bold leading-relaxed">
                To ignite a vibrant entrepreneurial culture and equip the youth
                with employable skills to create a robust industrial workforce
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 text-center md:text-left order-2 md:order-1">
              ...
              <div className="space-y-4 text-base sm:text-lg md:text-xl text-black font-bold leading-relaxed">
                <p>
                  To establish a strong framework that empowers entrepreneurs to
                  overcome challenges and develop scalable, sustainable
                  businesses.
                </p>
                <p>
                  To champion innovation as a key driver of India's economic
                  advancement.
                </p>
                <p>
                  To foster job creation, financial inclusivity and GDP growth
                  through the success of entrepreneurial ventures.
                </p>
              </div>
            </div>
      ...
      <section className="h-screen flex items-center justify-center px-4 sm:px-6 md:px-12 lg:px-16 relative overflow-hidden py-10">
        <img src="./media/page_5/5.png" className="absolute object-cover" />
        <div className="max-w-7xl w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative z-10">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4 sm:space-y-5">
              {[
                {
                  icon: GraduationCap,
                  text: "Employability & Skills Training",
                },
                { icon: Users, text: "Apprenticeship & Staffing" },
                {
                  icon: Building,
                  text: "Industry Academia Government Collaboration",
                },
          ...
          {/* <img src="./media/page_5/1.png" className="absolute object-cover z-10 left-0" /> */}
          <img src="./media/page_5/2.png" className="absolute object-cover z-20" />
          <img src="./media/page_5/3.png" className="absolute object-cover z-20" />
          <img src="./media/page_5/4.png" className="absolute object-cover z-10" />
        </div>
      </section>

      {/* Core Programs Section */}
      <section className="h-screen flex flex-col items-center justify-center px-4 sm:px-6 md:px-12 lg:px-16 py-10 lg:py-20">
        <img src="./media/page_6/6.png" className="absolute object-cover z-0" />
        <img src="./media/page_6/7.png" className="absolute object-cover z-0" />
        <div className="flex justify-center items-center px-4 sm:px-6 lg:px-16 mt-10 z-20">
        ...
        <div className="max-w-full w-full text-center">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 mt-10">
            {/* Card 1 */}
            <div className="z-20">
              <h3 className="text-xl sm:text-2xl md:text-4xl font-bold text-black mb-2">
                National<br />Apprenticeship<br /> Training Scheme<br/>(NATS)
              </h3>
            </div>
            ...
            <div className="z-20">
              <h3 className="text-xl sm:text-2xl md:text-4xl font-bold text-black mb-2">
                National<br /> Apprenticeship<br /> Promotion Scheme<br />(NAPS)
              </h3>
            </div>
            ...
            <div className="z-20">
              <h3 className="text-xl sm:text-2xl md:text-4xl font-bold text-black mb-2">
                Apprenticeship<br /> Embedded Degree<br /> Program (AEDP)
              </h3>
             </div>
            ...
            <div className="z-20">
              <h3 className="text-xl sm:text-2xl md:text-4xl font-bold text-black mb-2">
                Work Integrated Skills<br /> Training &<br /> Apprenticeships (WISTA)
              </h3>
            </div>
          </div>
        </div>
      ...
      <section className="h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 flex justify-center px-4 sm:px-6 md:px-12 lg:px-16 py-10">
        <img src="./media/page_7/1.png" className="absolute object-cover z-0" />
        <div className="max-w-7xl w-full text-center relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-10">
            ...
            {[
              ...
              >
                <div
                  className={`flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br ${item.color} rounded-xl mx-auto mb-4`}
                >
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-base sm:text-lg md:text-xl text-blue-700 font-medium leading-relaxed">
                Dynamic team of young professionals connected with the grassroot
                level in all cross sections of the society. Created impact in
                socio-economic upliftment through employable skills training,
                job facilitation & wealth-creating entrepreneurship trainings.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <ul className="text-sm sm:text-base text-gray-700 list-disc list-inside space-y-1">
                ...
                <li>
                  National Institute of Entrepreneurship & Small Business
                  Development, MSME
                </li>
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              <p className="text-sm sm:text-base md:text-lg text-gray-700 leading-relaxed">
                A seasoned socio-economic development leader with 20+ years of
                expertise in entrepreneurship training and large-scale skill
                development across India. A Gold Medalist and certified trainer
                by the IFC, World Bank, and NIESBUD, Vivek has empowered over
                25,000 youth through industry-integrated programs. He has held
                national leadership roles in premier skilling institutions and
                is a passionate advocate for "Viksit Bharat," delivering
                impactful sessions at top universities nationwide.
              </p>
            </div>
      ...
      <footer className="bg-gray-900 text-white py-12 px-6 md:px-12 lg:px-16">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
            <p>
              &copy; 2024 Resonance Entrepreneurship & Employability Solutions
